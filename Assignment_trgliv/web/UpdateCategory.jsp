        ...
        <div class="d-flex">
            ...
            <div class="container mt-5">
                ...
                <form action="update-category" method="post">
                    <div class="form-row">
                        <input value="${user.categoryId}" name="id" hidden="">
                        <div class="form-group col-md-6">
                            <label for="inputEmail4" style="font-weight: bold">Category Name</label>
                            <input type="text" class="form-control" id="inputEmail4" placeholder="Category Name" value="${user.categoryName}"  name="Name">
                        </div> 
                    </div>
